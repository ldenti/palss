...
GraphAligner --graph $WD/augmented-pass2.gfa --reads $WD/resulting_consensus.gaf.fa --alignments-out $WD/resulting_consensus_to_augmented.gaf --preset vg --threads $THREADS &> $WD/graphaligner_to_augmented.log

>&2 echo "[$(date)] Cleaning augmentation (2)"
python3 $SD/clean_ununsed.py $WD/augmented-pass2.gfa $WD/resulting_consensus.gaf $WD/consensus_to_augmented.gaf $WD/resulting_consensus_to_augmented.gaf $SUPP 2> $WD/cleaning-pass2.log | vg mod --unchop -
